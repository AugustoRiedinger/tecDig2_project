...
En esta función, además se reseta el flag =switchTemp= para ingresar a la misma. Luego de que se envía el código se habilita el flag para ingresar a la función de recepción de dicho valor de temperatura.
...
Esta función se encarga de transmitir el comando necesario para inciar el movimiento del servomotor en el SATDAC. Aquí además se reinicia el flag del switch correspondiente:
